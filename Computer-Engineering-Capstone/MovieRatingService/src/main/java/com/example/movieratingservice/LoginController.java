...
public class LoginController {
    ...
    public void userRegistration(){
        ...
        String msg = String.valueOf(um.registerUser("Jo", "Jo", "jom@j.com", "Qwerty123@", 100.0));
        System.out.println(msg);
    }

    public void userLogin(){
        UserManager um = new UserManager();
        String msg = String.valueOf(um.loginUser("jj@jj.com", "Pwerty12345$"));
        System.out.println(msg);
    ...
    public void updateUserDetails() {
        UserManager um = new UserManager();
        CompletableFuture<String> msg = um.updateUserDetails("6243e742-c96f-4d71-bd0c-8869a4708f8b", "Jjrr", "Jjjj", "jj@jj.com");
        System.out.println(msg);
    }

    public void updateUserPassword() {
        UserManager um = new UserManager();
        CompletableFuture<String> msg = um.updateUserPassword("6243e742-c96f-4d71-bd0c-8869a4708f8b", "Pwerty12345$", "Qwerty123@");
        System.out.println(msg);
    }
